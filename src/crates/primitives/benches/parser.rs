...
use tx_indexer_primitives::{
    dense::{BitcoindDataDirectory, IndexPaths},
...
fn bench_parse_mainnet_702861(c: &mut Criterion) {
    ...
    let data_dir = temp_dir("tx_indexer_bench_blocks");
    write_single_block_file(&data_dir, block_bytes).expect("write block file");
    ...
    c.bench_function("dense_parse_mainnet_702861", |b| {
        b.iter_batched(
            ...
            |(paths, index_dir)| {
                let mut parser = Parser::new(BitcoindDataDirectory::new(&data_dir));
